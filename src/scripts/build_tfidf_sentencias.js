/**
 * build_tfidf_sentencias.js — Build TF-IDF vocabulary + sparse vectors for sentencias collection.
 *
 * Input:  data/chunks/sentencias_enriched.json
 * Output:
 *   - data/tfidf_vocabulary_sentencias.json
 *   - data/chunks/sentencias_sparse_vectors.json
 *
 * Usage:
 *   node src/scripts/build_tfidf_sentencias.js
 */

const fs = require('fs');
const path = require('path');

const INPUT_PATH = path.join(__dirname, '..', '..', 'data', 'chunks', 'sentencias_enriched.json');
const VOCAB_OUTPUT = path.join(__dirname, '..', '..', 'data', 'tfidf_vocabulary_sentencias.json');
const SPARSE_OUTPUT = path.join(__dirname, '..', '..', 'data', 'chunks', 'sentencias_sparse_vectors.json');
...
function buildDocumentText(item) {
    ...
    if (item.fallo) parts.push(item.fallo);
...
function main() {
    console.log('=== Build Sentencias TF-IDF Vocabulary & Sparse Vectors ===\n');
    ...
    console.log(`Loaded ${N} sentencias`);
