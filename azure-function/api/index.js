// Azure Function - Proxy generico para Azure OpenAI / Azure AI
// Acepta _apikey, _host y _path para redirigir a cualquier endpoint
// Si no se pasan _host/_path, usa los defaults de Azure OpenAI
...
module.exports = async function (context, req) {
    ...
    // Permitir que el cliente envie su propia key, host y path
    ...
    // Limpiar campos internos del body antes de enviarlo
